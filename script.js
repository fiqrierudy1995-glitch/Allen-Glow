...
// ==========================
calendarBtn?.addEventListener("click", e=>{e.preventDefault(); popupCal.style.display="flex";});
popupCal?.addEventListener("click", e=>{if(e.target===popupCal) popupCal.style.display="none";});
androidBtn?.addEventListener("click", ()=>{window.open("https://calendar.google.com/calendar/u/0/r/eventedit?text=Wedding+Celebration+of+Allen+and+Glow&dates=20251227T030000Z/20251227T080000Z&details=Ceremony+at+The+Parish+of+St+Michael+%26+All+Angels,+Sandakan%0AReception+at+D'Rimba+House&location=The+Parish+of+St+Michael+%26+All+Angels,+Sandakan+(Ceremony)+%26+D'Rimba+House+(Reception)","_blank"); popupCal.style.display="none";});
iosBtn?.addEventListener("click", ()=>{const ics=`BEGIN:VCALENDAR\nVERSION:2.0\nPRODID:-//Allen & Glow Wedding//Event Calendar//EN\nCALSCALE:GREGORIAN\nBEGIN:VEVENT\nUID:20251227T110000Z-AllenGlow@example.com\nDTSTAMP:20251107T000000Z\nDTSTART:20251227T030000Z\nDTEND:20251227T080000Z\nSUMMARY:Wedding Celebration of Allen & Glow\nDESCRIPTION:Ceremony at The Parish of St Michael & All Angels, Sandakan (03:00 - 05:00 UTC)\\nReception at D'Rimba House (06:00 - 08:00 UTC)\\nJoin us for a day filled with love, joy, and blessings.\nLOCATION:The Parish of St Michael & All Angels, Sandakan (Ceremony) & D'Rimba House (Reception)\nEND:VEVENT\nEND:VCALENDAR\n`; const blob=new Blob([ics],{type:"text/calendar"}); const link=document.createElement("a"); link.href=URL.createObjectURL(blob); link.download="walimatulurus.ics"; link.click(); popupCal.style.display="none";});
  ...
  try {
    ...
    if (data.status === "success") {
      ...
      messageDiv.style.backgroundColor =
        rsvpChoice === "Hadir" ? "#e7f1f8" : "#ffdd57";
